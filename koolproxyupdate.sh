...
wget 'https://0.0.0.0' -O files/usr/share/koolproxy/data/rules/yhosts.txt
...
wget 'https://0.0.0.0' -O files/usr/share/koolproxy/data/rules/easylistchina.txt
...
wget https://0.0.0.0 -O- | grep ^\|\|[^\*]*\^$ | sed -e 's:||:address\=\/:' -e 's:\^:/0\.0\.0\.0:' > files/usr/share/koolproxy/dnsmasq.adblock
